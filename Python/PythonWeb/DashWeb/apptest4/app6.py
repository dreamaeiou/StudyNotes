        ...
        [
            ...
            dbc.Row(
                dbc.Col(
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("贷款金额", className="prepend"),
                            dbc.Input(
                                id='loan_amount',
                            ...
                            dbc.InputGroupText("万元", className="append"),
                        ],
                    ),
            ...
            dbc.Row(
                dbc.Col(
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("计划还款月数:", className="prepend"),
                            dbc.Input(
                            ...
                            dbc.InputGroupText("个月", className="append"),
                        ],
                    ),
                    width={'size': 6, 'offset': 3}
                )
            ...
            dbc.Row(
                dbc.Col(
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("年利率", className="prepend"),
                            dbc.Input(
                                id='interest_rate',
                                placeholder='请输入年利率',
                                type="number",
                            ...
                            dbc.InputGroupText("%", className="append"),
                        ],
                    ),
                    width={'size': 6, 'offset': 3}
                )
